...
const HomePage = () => {
    return (
        <>
            <h1 className='row-start-1 row-span-4 col-start-1 grid md:grid-rows-3 md:grid-cols-5 text-5xl md:text-7xl gap-4 font-semibold self-center text-center text-primary-col drop-shadow-md'>
            ...
            <Link to={'/register'} className='pb-16 row-start-5 col-start-1 w-full flex justify-center items-center'>
