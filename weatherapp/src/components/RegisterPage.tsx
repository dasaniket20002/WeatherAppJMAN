...
const RegisterPage = () => {
    ...
    return (
        <div className="col-start-1 row-span-full col-span-full flex flex-col items-center justify-center w-full md:w-1/2 px-6 m-auto gap-9">
            {isLogin ?
                <>
                    <h1 className="text-5xl leading-[1.25] font-semibold self-center text-center text-primary-col drop-shadow-md mb-10">Register</h1>
                    <form className="w-full h-full flex flex-col items-center justify-center gap-10" action="">
                        <InputField
                            fieldType={"text"}
                            fieldID={"name"}
                            fieldName={"Name"}
                ...
                :
                <>
                    <h1 className="text-5xl leading-[1.25] font-semibold self-center text-center text-primary-col drop-shadow-md mb-10">Login</h1>
                    <form className="w-full h-full flex flex-col items-center justify-center gap-10" action="">
                        <InputField
                            fieldType={"email"}
                            fieldID={"email"}
